...
namespace SplineMesh
{
    ...
    public struct CurveSample
    {
        ...
        public CurveSample(Vector3 location, Vector3 tangent, Vector3 up, Vector2 scale, float roll, float distanceInCurve, float timeInCurve, float distanceInSpline, CubicBezierCurve curve)
        {
            ...
            this.curve = curve;
            this.distanceInSpline = distanceInSpline;
        ...
        public static CurveSample Lerp(CurveSample a, CurveSample b, float t)
        {
            return new CurveSample(
                ...
                Mathf.Lerp(a.timeInCurve, b.timeInCurve, t),
                   Mathf.Lerp(a.distanceInSpline, b.distanceInSpline, t),
                a.curve);
        }
